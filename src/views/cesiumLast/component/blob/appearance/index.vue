      ...
      material: new Cesium.Material({
        fabric: {
          ...
          uniforms: {
            image: rgbaPng, // 图像的路径
            repeat: new Cesium.Cartesian2(2, 1), // 可调整重复次数
            channels: 'a',// 图像通道,需三个字符串,包含 r、g、b 和 a 的任意组合
          }
        }
      })
    })
...
const addMaterialAppearanceElevationContour = () => {
  ...
  //         uniforms: {
  //           color: Cesium.Color.fromCssColorString("red").withAlpha(1),
  //           spacing: 10,           // 每隔100米绘制一条等高线
  //           width: 2,               // 线宽
  //         }
  //       }
  //     })
