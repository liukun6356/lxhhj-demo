...
import bumpmapPng from "./bumpmap.png"
import normalmapPng from "./normalmap.png"
...
const addMaterialAppearanceColor = () => {
  ...
  const geometry = Cesium.RectangleGeometry.createGeometry(rect)
