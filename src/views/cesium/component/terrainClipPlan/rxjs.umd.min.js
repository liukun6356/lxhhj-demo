...
function Sa(c, a, b) {
    ...
    return function () {
        ...
        var f = this, g, l = {context: f, subject: g, callbackFunc: c, scheduler: b};
...
function Rb(c) {
    ...
    c = c.params;
    var e = c.callbackFunc, f = c.context, g = c.scheduler, l = c.subject;
    if (!l) {
        l = c.subject = new U;
        try {
...
function Ta(c, a, b) {
    ...
    return function () {
        for (var a = [], e = 0; e < arguments.length; e++) a[e] = arguments[e];
        var f = {subject: void 0, args: a, callbackFunc: c, scheduler: b, context: this};
        return new n(function (d) {
            var e = f.context, g = f.subject;
            if (b) return b.schedule(Tb, 0, {
                params: f,
...
function Tb(c) {
    ...
    c = c.context;
    var e = b.callbackFunc, f = b.args, g = b.scheduler, l = b.subject;
    if (!l) {
        l = b.subject = new U;
        try {
            e.apply(c, f.concat([function () {
                for (var b = [], c = 0; c < arguments.length; c++) b[c] =
                    arguments[c];
                (c = b.shift()) ? a.add(g.schedule(Ua, 0, {
                    err: c,
                    subject: l
                })) : a.add(g.schedule(Ub, 0, {value: 1 >= b.length ? b[0] : b, subject: l}))
            }]))
        } catch (u) {
...
function Wa(c, a) {
    if (null != c) {
        if (c && "function" ===
            typeof c[V]) return Vb(c, a);
        if (Va(c)) return Wb(c, a);
        if (Xa(c)) return wa(c, a);
        if (c && "function" === typeof c[F] || "string" === typeof c) return Xb(c, a)
    }
...
function ja(c, a) {
    return new n(function (b) {
        var d = c.length;
        if (0 === d) b.complete(); else for (var e = Array(d), f = 0, g = 0, l = function (l) {
            var h = G(c[l]), u = !1;
            b.add(h.subscribe({
                next: function (b) {
                    u ||
...
function Za(c, a, b, d) {
    Q(b) && (d = b, b = void 0);
    return d ? Za(c, a, b).pipe(B(function (b) {
...
function $a(c, a, b, d, e) {
    var f;
    if (c && "function" === typeof c.addEventListener &&
        "function" === typeof c.removeEventListener) c.addEventListener(a, b, e), f = function () {
        return c.removeEventListener(a, b, e)
    }; else if (c && "function" === typeof c.on && "function" === typeof c.off) c.on(a, b), f = function () {
        return c.off(a, b)
    ...
    }; else if (c && c.length) for (var g = 0, l = c.length; g < l; g++) $a(c[g], a, b, d, e); else throw new TypeError("Invalid event target");
    d.add(f)
}
...
function bc(c) {
    var a = c.subscriber, b = c.condition;
    if (!a.closed) {
...
function cc(c) {
    var a = c.subscriber, b = c.counter;
    c = c.period;
    a.next(b);
...
function bb() {
    for (var c = [], a = 0; a < arguments.length; a++) c[a] = arguments[a];
    var a = Number.POSITIVE_INFINITY, b = null, d = c[c.length - 1];
    A(d) ? (b = c.pop(), 1 < c.length &&
    "number" === typeof c[c.length - 1] && (a = c.pop())) : "number" === typeof d && (a = c.pop());
    return null === b && 1 === c.length && c[0] instanceof n ? c[0] : za(a)(Z(c, b))
}

function Ba() {
    for (var c = [], a = 0; a < arguments.length; a++) c[a] = arguments[a];
    if (0 === c.length) return T;
    var b = c[0], d = c.slice(1);
    return 1 === c.length && x(b) ? Ba.apply(void 0, b) : new n(function (a) {
        var c = function () {
...
function dc(c) {
    var a = c.keys, b = c.index,
        d = c.subscriber, e = c.subscription;
    c = c.obj;
    if (!d.closed) if (b < a.length) {
        var f = a[b];
        d.next([f, c[f]]);
        e.add(this.schedule({keys: a, index: b + 1, subscriber: d, subscription: e, obj: c}))
    } else d.complete()
}
...
function db() {
    for (var c = [], a = 0; a < arguments.length; a++) c[a] = arguments[a];
    if (1 === c.length) if (x(c[0])) c = c[0]; else return c[0];
...
function hc(c) {
    var a = c.index, b = c.period, d = c.subscriber;
    d.next(a);
    if (!d.closed) {
...
function fb() {
    for (var c =
        [], a = 0; a < arguments.length; a++) c[a] = arguments[a];
    a = c[c.length - 1];
...
function jc(c) {
    var a = c.bufferCreationInterval, b = c.bufferTimeSpan, d = c.subscriber, e = c.scheduler, f = d.openContext();
    d.closed || (d.add(f.closeAction = e.schedule(jb,
...
function vc(c, a) {
    return function (b) {
        var d = b;
        for (b = 0; b < a; b++) if (d = d[c[b]], "undefined" === typeof d) return;
        return d
    }
}
...
function yc(c) {
    ...
    a ? Number.POSITIVE_INFINITY : a, e = c.refCount, f = c.scheduler, g, l = 0, h, k = !1, r = !1;
    return function (a) {
        l++;
        if (!g || k) k = !1, g = new X(b, d, f), h = a.subscribe({
            next: function (b) {
                g.next(b)
            }, error: function (b) {
                k = !0;
...
function Dc(c) {
    var a = c.subscriber, b = c.windowTimeSpan, d = c.window;
    d && a.closeWindow(d);
...
function Ec(c) {
    var a = c.windowTimeSpan, b = c.subscriber, d = c.scheduler, e = c.windowCreationInterval,
        f = b.openWindow(), g = {action: this, subscription: null};
    g.subscription = d.schedule(ob, a, {subscriber: b, window: f, context: g});
...
function pb(c, a) {
    for (var b = 0, d = a.length; b < d; b++) for (var e = a[b], f = Object.getOwnPropertyNames(e.prototype), g = 0, l = f.length; g < l; g++) {
        var h = f[g];
...
var Y = Ma, t = function () {
    ...
    c.prototype.unsubscribe = function () {
        var a;
        if (!this.closed) {
            var b = this._parentOrParents, d = this._unsubscribe, e = this._subscriptions;
            this.closed =
                !0;
            this._subscriptions = this._parentOrParents = null;
            if (b instanceof c) b.remove(this); else if (null !== b) for (var f = 0; f < b.length; ++f) b[f].remove(this);
            if (Q(d)) try {
                d.call(this)
            } catch (g) {
                a = g instanceof Y ? Na(g.errors) : [g]
            }
            if (x(e)) for (f = -1, b = e.length; ++f < b;) if (d = e[f], sa(d)) try {
                d.unsubscribe()
            } catch (g) {
    ...
    c.prototype.add = function (a) {
        ...
        switch (typeof a) {
            ...
            case "object":
                if (b === this ||
                    b.closed || "function" !== typeof b.unsubscribe) return b;
        ...
        if (null === a) b._parentOrParents = this; else if (a instanceof c) {
            if (a === this) return b;
            b._parentOrParents = [a, this]
        } else if (-1 === a.indexOf(this)) a.push(this); else return b;
            ...
            case 1:
                ...
                if ("object" === typeof b) {
                    b instanceof a ? (f.syncErrorThrowable =
                        b.syncErrorThrowable, f.destination = b, b.add(f)) : (f.syncErrorThrowable = !0, f.destination = new sb(f, b));
                    break
                }
            default:
    ...
    function a(b, a, e, f) {
        ...
        var l;
        b = d;
        Q(a) ? l = a : a && (l = a.next, e = a.error, f = a.complete, a !== oa && (b = Object.create(a), Q(b.unsubscribe) && d.add(b.unsubscribe.bind(b)), b.unsubscribe = d.unsubscribe.bind(d)));
        d._context = b;
        d._next = l;
        d._error = e;
        d._complete = f;
    ...
    a.prototype.error = function (b) {
        if (!this.isStopped) {
            ...
            if (this._error) c && a.syncErrorThrowable ? this.__tryOrSetError(a, this._error, b) : this.__tryOrUnsub(this._error, b), this.unsubscribe(); else if (a.syncErrorThrowable) c ? (a.syncErrorValue = b, a.syncErrorThrown = !0) : R(b), this.unsubscribe(); else {
                this.unsubscribe();
                if (c) throw b;
                R(b)
            }
    ...
    c.prototype.subscribe =
        function (a, b, c) {
            ...
            d ? a.add(d.call(a, this.source)) : a.add(this.source || C.useDeprecatedSynchronousErrorHandling && !a.syncErrorThrowable ? this._subscribe(a) : this._trySubscribe(a));
...
var tb = function (c) {
    ...
    a.prototype.connect = function () {
        ...
        b || (this._isComplete = !1, b = this._connection = new t, b.add(this.source.subscribe(new Oc(this.getSubject(),
            this))), b.closed && (this._connection = null, b = t.EMPTY));
        return b
    };
...
var Qc = function () {
    ...
    a.prototype._group = function (b, a) {
        ...
        if (this.elementSelector) try {
            ...
            b;
        if (!d && (d = this.subjectSelector ? this.subjectSelector() : new v, c.set(a, d), b = new Fa(a, d, this), this.destination.next(b), this.durationSelector)) {
            b = void 0;
            try {
    ...
    h(a, c);
    a.prototype._subscribe = function (b) {
        var a = new t, c = this.refCountSubscription, f = this.groupSubject;
    ...
    a.prototype.unsubscribe = function () {
        var b = this.parent;
        b.closed || this.closed || (c.prototype.unsubscribe.call(this),
    ...
    a.prototype.schedule = function (b, d, e) {
        void 0 === d && (d = 0);
        return a.delegate && a.delegate !==
        this ? a.delegate.schedule(b, d, e) : c.prototype.schedule.call(this, b, d, e)
    };
    a.prototype.flush = function (b) {
        var a = this.actions;
        if (this.active) a.push(b); else {
            var c;
            this.active = !0;
            do if (c = b.execute(b.state, b.delay)) break; while (b = a.shift());
            this.active = !1;
            if (c) {
    ...
    h(a, c);
    return a
}(P))(Tc), T = new n(function (c) {
    return c.complete()
}), Qa = function (c) {
    return function (a) {
        for (var b =
            0, d = c.length; b < d && !a.closed; b++) a.next(c[b]);
        a.complete()
    }
};
(function (c) {
...
var w = function () {
    ...
    X = function (c) {
        ...
        a.prototype._subscribe = function (b) {
            var a = this._infiniteTimeWindow, c = a ? this._events : this._trimBufferThenGetEvents(),
                f = this.scheduler, g = c.length, l;
            if (this.closed) throw new E;
            this.isStopped || this.hasError ? l = t.EMPTY : (this.observers.push(b), l = new tb(this, b));
            f && b.add(b = new yb(b, f));
            if (a) for (a = 0; a < g && !b.closed; a++) b.next(c[a]); else for (a = 0; a < g && !b.closed; a++) b.next(c[a].value);
        ...
        a.prototype.complete = function () {
            this.hasCompleted = !0;
            this.hasNext && c.prototype.next.call(this,
                this.value);
        ...
        a.prototype.requestAsyncId = function (b, a, e) {
            ...
            b.actions.push(this);
            return b.scheduled || (b.scheduled =
        ...
        a.prototype.flush = function (b) {
            ...
            var a = this.actions, c, f = -1, g = a.length;
            b = b || a.shift();
            do if (c = b.execute(b.state,
                b.delay)) break; while (++f < g && (b = a.shift()));
            this.active = !1;
            if (c) {
        ...
        a.prototype.flush = function (b) {
            ...
            var a = this.actions, c, f = -1, g = a.length;
            b = b || a.shift();
            do if (c = b.execute(b.state, b.delay)) break; while (++f < g && (b = a.shift()));
            this.active = !1;
            if (c) {
                for (; ++f <
                       g && (b = a.shift());) b.unsubscribe();
                throw c;
            }
        };
        return a
        ...
        a.prototype.flush = function () {
            for (var b = this.actions, a = this.maxFrames, c, f; (f = b[0]) && f.delay <= a && !(b.shift(), this.frame = f.delay, c = f.execute(f.state, f.delay));) ;
            if (c) {
...
var cd = function (c) {
        ...
        a.prototype._complete = function () {
            ...
            if (0 === a) this.destination.complete(); else {
        ...
        a.prototype.notifyNext = function (b, a, c, f, g) {
            if (!this.hasFirst) {
                this.hasFirst = !0;
                for (b = 0; b < this.subscriptions.length; b++) b !== c && (f = this.subscriptions[b], f.unsubscribe(), this.remove(f));
        ...
        a.prototype._next = function (b) {
            ...
            x(b) ? a.push(new jd(b)) : "function" === typeof b[F] ? a.push(new kd(b[F]())) : a.push(new ld(this.destination, this, b))
        };
        a.prototype._complete = function () {
            var b = this.iterators, a = b.length;
            this.unsubscribe();
            if (0 === a) this.destination.complete(); else {
                this.active =
                    a;
        ...
        a.prototype.checkIterators = function () {
            ...
            this.resultSelector ?
                this._tryresultSelector(h) : c.next(h);
            l && c.complete()
        };
        a.prototype._tryresultSelector = function (b) {
            var a;
        ...
        a.prototype.next = function () {
            var b = this.buffer;
            return 0 === b.length && this.isComplete ? {value: null, done: !0} : {value: b.shift(), done: !1}
        };
        ...
        a.prototype._next = function (b) {
            ...
            if (!this.throttled) {
                var a =
                    void 0;
                try {
                    var c = this.durationSelector, a = c(b)
                } catch (f) {
    ...
    od = function () {
        ...
        function c(a, b) {
            this.bufferSize = a;
            this.subscriberClass = (this.startBufferEvery = b) && a !==
            b ? pd : qd
        }
        ...
        function (c) {
            ...
            a.prototype._next = function (b) {
                ...
                this.count++;
                0 === g % c && f.push([]);
                for (c = f.length; c--;) g = f[c], g.push(b), g.length === a && (f.splice(c, 1), this.destination.next(g))
            };
            a.prototype._complete = function () {
        ...
        function a(b, a, e, f, g) {
            ...
            if (b.timespanOnly) b.add(f.closeAction = g.schedule(ib, a, {
                subscriber: b,
                context: f,
                bufferTimeSpan: a
            })); else {
                var d = {bufferTimeSpan: a, bufferCreationInterval: e, subscriber: b, scheduler: g};
                b.add(f.closeAction = g.schedule(jb, a, {subscriber: b, context: f}));
        ...
        a.prototype.onBufferFull = function (b) {
            ...
            if (!this.closed && this.timespanOnly) {
                ...
                this.add(b.closeAction = this.scheduler.schedule(ib,
        ...
        a.prototype.trySubscribe = function (b) {
            var a = this.contexts, c = new t, f = {buffer: [], subscription: c};
            a.push(f);
            b = p(this, b, f);
    ...
    Dd = function (c) {
        ...
        a.prototype._next = function (b) {
            ...
            this.lastValue = b;
            this.hasValue = !0;
            this.add(this.debouncedSubscription = this.scheduler.schedule(kc, this.dueTime, this))
        };
        a.prototype._complete = function () {
            this.debouncedNext();
            this.destination.complete()
    ...
    Sd = function (c) {
        ...
        a.prototype._next = function (b) {
            ...
            c = !1;
            if (this.hasKey) try {
                var f = this.compare, c = f(this.key, a)
            } catch (g) {
                return this.destination.error(g)
            } else this.hasKey = !0;
    ...
    Yd = function () {
        ...
        a.prototype._next = function (b) {
            ...
            if (c.closed) this._complete(); else {
                var e = this.index++;
                if (this.active < this.concurrent) {
                    c.next(b);
                    try {
                        var f = this.project, g = f(b, e);
                        this.scheduler ? this.destination.add(this.scheduler.schedule(a.dispatch, 0, {
                            subscriber: this,
                            result: g,
                            value: b,
                            index: e
    ...
    be = function (c) {
        ...
        a.prototype._complete = function () {
            ...
            if (0 < a) for (var c = this.count >= this.total ? this.total : this.count, f = this.ring, g = 0; g < c; g++) {
                var l = a++ % c;
                b.next(f[l])
            }
            b.complete()
        ...
        a.prototype._next = function (b) {
            if (this.active < this.concurrent) {
                var a = this.index++, c = this.destination, f = void 0;
                try {
                    var g = this.accumulator, f = g(this.acc, b, a)
                } catch (l) {
                    return c.error(l)
                }
                this.active++;
        ...
        c.prototype.call = function (a, b) {
            var c = this.selector, e = this.subjectFactory();
            a = c(e).subscribe(a);
            a.add(b.subscribe(e));
            return a
        };
        ...
        a.prototype.error = function (b) {
            if (!this.isStopped) {
                var a =
                    this.errors, e = this.retries, f = this.retriesSubscription;
                if (e) this.retriesSubscription = this.errors = null; else {
                    a = new v;
                    try {
                        var g = this.notifier, e = g(a)
                    } catch (l) {
        ...
        function a(b, a, e) {
            ...
            d._b = [];
            d._oneComplete = !1;
            d.destination.add(a.subscribe(new He(b,
                d)));
            return d
        }
        ...
        h(a, c);
        a.prototype._next = function (b) {
            var a = this._skipCount, c = this._count++;
            if (c < a) this._ring[c] = b; else {
        ...
        a.prototype._complete = function () {
            ...
            a &&
            !a.closed || c.prototype._complete.call(this);
            this.unsubscribe()
        };
        a.prototype._unsubscribe = function () {
        ...
        c.prototype.call = function (a, b) {
            ...
            return c && !a.seenValue ? (a.add(c), b.subscribe(a)) :
                a
        };
        return c
    }(), Ve = function (c) {
        ...
        function a(a,
            ...
            a._tapError = e || D;
            a._tapComplete = f || D;
            Q(d) ? (a._context = a, a._tapNext = d) : d && (a._context = d, a._tapNext = d.next || D, a._tapError = d.error || D, a._tapComplete = d.complete || D);
            return a
        }
        ...
        return a
    }(m), Gb = {leading: !0, trailing: !1}, bf = function () {
        function c(a, b, c) {
            this.durationSelector = a;
            this.leading = b;
            this.trailing = c
    ...
    cf = function (c) {
        ...
        a.prototype.openWindow = function () {
            var a = this.window;
            a && a.complete();
            var a = this.destination, c = this.window = new v;
            a.next(c)
        };
        return a
    }(q), lf = function () {
        ...
        function a(a, d, e, f, g) {
            ...
            null !== e && 0 <= e ? (f = {
                ...
                subscriber: b,
                scheduler: g
            }, b.add(g.schedule(ob, d, {
                subscriber: b,
                window: a,
                context: null
            })), b.add(g.schedule(Ec, e, f))) : b.add(g.schedule(Dc, d, {subscriber: b, window: a, windowTimeSpan: d}));
            return b
        }
        ...
        a.prototype._error = function (a) {
            for (var b =
                this.windows; 0 < b.length;) b.shift().error(a);
            this.destination.error(a)
        };
        a.prototype._complete = function () {
        ...
        a.prototype._error = function (a) {
            var b = this.contexts;
            this.contexts = null;
            if (b) for (var e = b.length, f = -1; ++f < e;) {
                var g = b[f];
                g.window.error(a);
                g.subscription.unsubscribe()
            }
            c.prototype._error.call(this,
                a)
        };
        a.prototype._complete = function () {
            var a = this.contexts;
            this.contexts = null;
            if (a) for (var d = a.length, e = -1; ++e < d;) {
                var f = a[e];
                f.window.complete();
        ...
        a.prototype._unsubscribe = function () {
            var a = this.contexts;
            this.contexts = null;
            if (a) for (var c = a.length, e = -1; ++e < c;) {
                var f = a[e];
        ...
        a.prototype.closeWindow = function (a) {
            if (-1 !== a) {
                var b = this.contexts, c = b[a], f = c.window, c = c.subscription;
                b.splice(a,
                    1);
                f.complete();
                c.unsubscribe()
        ...
        audit: hb, auditTime: function (c, a) {
            void 0 === a && (a = y);
            return hb(function () {
                return eb(c, a)
            })
        ...
        }, concatAll: Ya, concatMap: kb, concatMapTo: function (c, a) {
            return kb(function () {
                return c
            }, a)
        }, count: function (c) {
        ...
        }, defaultIfEmpty: ba, delay: function (c, a) {
            void 0 === a && (a = y);
        ...
        }, distinctUntilChanged: lb, distinctUntilKeyChanged: function (c, a) {
        ...
        }, exhaustMap: mb, expand: function (c, a, b) {
            void 0 === a && (a = Number.POSITIVE_INFINITY);
            void 0 === b && (b = void 0);
        ...
        flatMap: M, mergeMapTo: function (c, a, b) {
            void 0 === b && (b = Number.POSITIVE_INFINITY);
            if ("function" === typeof a) return M(function () {
                return c
            }, a, b);
            "number" === typeof a && (b = a);
            return M(function () {
        ...
        }, multicast: N, observeOn: function (c, a) {
            void 0 === a && (a = 0);
            return function (b) {
        ...
        publish: function (c) {
            ...
            var e = "function" === typeof b ? b : void 0, f = new X(c, a, d);
            return function (a) {
                return N(function () {
                    return f
                }, e)(a)
        ...
        }, refCount: va, sample: function (c) {
            return function (a) {
                return a.lift(new Ce(c))
            }
        }, sampleTime: function (c,
                                 a) {
            void 0 === a && (a = y);
            return function (b) {
                return b.lift(new Ee(c, a))
            }
        }, scan: ma, sequenceEqual: function (c, a) {
            return function (b) {
            ...
            var d;
            d = c && "object" === typeof c ? c : {bufferSize: c, windowTime: a, refCount: !1, scheduler: b};
            return function (a) {
                return a.lift(yc(d))
            }
        }, single: function (c) {
        ...
        skipUntil: function (c) {
            ...
            return da(J)
        }, switchMap: da, switchMapTo: function (c, a) {
        ...
        }, take: Ca, takeLast: la, takeUntil: function (c) {
            return function (a) {
                return a.lift(new We(c))
            }
        ...
        }, throwIfEmpty: ka, timeInterval: function (c) {
            void 0 === c && (c = y);
            return function (a) {
                return Aa(function () {
        ...
        }, timeoutWith: nb, timestamp: function (c) {
            void 0 === c && (c = y);
            return B(function (a) {
            ...
            var e = y, f = null, g = Number.POSITIVE_INFINITY;
            A(d) && (e = d);
            A(b) ? e = b : W(b) && (g = b);
            A(a) ? e = a : W(a) && (f = a);
            return function (a) {
        ...
        function a(a, d) {
            var b = c.call(this, function (a) {
                var b = this, c = b.logSubscribedFrame(), d = new t;
...
var Ib = function (c) {
    ...
    a.prototype._subscribe = function (a) {
        var b = this, e = b.logSubscribedFrame(), f = new t;
...
var xf = function (c) {
        ...
        a.prototype.expectObservable = function (b, c) {
            ...
            c = a.parseMarblesAsSubscriptions(c,
                this.runMode);
            var h = c.unsubscribedFrame, k;
        ...
        a.parseMarblesAsSubscriptions = function (a, c) {
            ...
            for (var d = a.length, g = -1, h = Number.POSITIVE_INFINITY, k = Number.POSITIVE_INFINITY, m = 0, r = function (d) {
        ...
        return a
    }(Ab), yf = Object.freeze({TestScheduler: xf}),
    zf = "undefined" !== typeof self && "undefined" !== typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && self,
    Af = "undefined" !== typeof global && global, z = "undefined" !== typeof window && window || Af || zf;
...
var Lc = B(function (c, a) {
    ...
    function a(a) {
        var b =
            ...
            async: !0, createXHR: function () {
                var a;
                if (this.crossDomain) if (z.XMLHttpRequest) a = new z.XMLHttpRequest; else if (z.XDomainRequest) a = new z.XDomainRequest; else throw Error("CORS is not supported by your browser"); else if (z.XMLHttpRequest) a = new z.XMLHttpRequest; else {
                    var b = void 0;
                    try {
        ...
        if ("string" === typeof a) e.url = a; else for (var f in a) a.hasOwnProperty(f) && (e[f] = a[f]);
        b.request = e;
        return b
    }
    ...
    function a(a, d) {
        ...
        var b =
            d.headers = d.headers || {};
        d.crossDomain || a.getHeader(b, "X-Requested-With") || (b["X-Requested-With"] = "XMLHttpRequest");
    ...
    a.prototype.next = function (a) {
        this.done = !0;
        var b = this.xhr, c = this.request, f = this.destination, g;
        try {
            g = new Jb(a, b, c)
        } catch (l) {
            return f.error(l)
    ...
    a.prototype.send = function () {
        var a = this.request, c = this.request, e = c.user, f = c.method, g = c.url, h = c.async, k = c.password,
            m = c.headers, c = c.body;
        try {
    ...
    a.prototype.setupEvents = function (a, c) {
        function b(a) {
            var c = b.subscriber, d = b.progressSubscriber, e = b.request;
            d && d.error(a);
            var f;
            try {
                f = new Kb(this, e)
        ...
        if (a.upload && "withCredentials" in a) {
            ...
            var m;
            m = function (a) {
                var b = m.progressSubscriber, c = m.subscriber, d = m.request;
                b && b.error(a);
                var e;
                try {
    ...
    return function (c, a, b) {
        ...
        this.status = a.status;
        this.responseType = a.responseType || b.responseType;
        this.response = rb(this.responseType,
            a)
    }
}();
qb.prototype = Object.create(Error.prototype);
var ra = qb, Kb = function (c, a) {
    ra.call(this, "ajax timeout", c, a);
    this.name = "AjaxTimeoutError";
    return this
}, Cf = Object.freeze({ajax: O.create, AjaxResponse: Jb, AjaxError: ra, AjaxTimeoutError: Kb}), Df = {
    url: "", deserializer: function (c) {
    ...
    function a(a, d) {
        var b = c.call(this) || this;
        if (a instanceof n) b.destination = d, b.source = a; else {
            d = b._config = Mc({}, Df);
            b._output = new v;
            if ("string" ===
                typeof a) d.url = a; else for (var f in a) a.hasOwnProperty(f) && (d[f] = a[f]);
    ...
    a.prototype._connectSocket = function () {
        var a = this, c = this._config, e = c.WebSocketCtor, f = c.protocol, g = c.url, c = c.binaryType,
            h = this._output, k = null;
        try {
    ...
    fromFetch: function (c, a) {
        return new n(function (b) {
            var d =
                new AbortController, e = d.signal, f = !0, g = !1;
            a ? (a.signal && a.signal.addEventListener("abort", function () {
                e.aborted || d.abort()
            }), a.signal = e) : a = {signal: e};
...
k.forkJoin = function () {
    ...
    if (1 === c.length) {
        ...
        if (sa(b) && Object.getPrototypeOf(b) === Object.prototype) return c = Object.keys(b), ja(c.map(function (a) {
            return b[a]
        }), c)
    }
    if ("function" === typeof c[c.length -
    1]) {
        var d = c.pop(), c = 1 === c.length && x(c[0]) ? c[0] : c;
        return ja(c, null).pipe(B(function (a) {
...
k.generate = function (c, a, b, d, e) {
    ...
    return new n(function (c) {
        var d = g;
        if (e) return e.schedule(bc, 0, {subscriber: c, iterate: b, condition: a, resultSelector: f, state: d});
        do {
            if (a) {
                var h = void 0;
                try {
...
k.pairs = function (c, a) {
    return a ? new n(function (b) {
        var d = Object.keys(c), e = new t;
        e.add(a.schedule(dc, 0, {keys: d, index: 0, subscriber: b, subscription: e, obj: c}));
        return e
    }) : new n(function (a) {
...
k.range = function (c, a, b) {
    ...
    return new n(function (d) {
        void 0 === a && (a = c, c = 0);
        var e = 0, f = c;
        if (b) return b.schedule(gc, 0, {index: e, count: a, start: c, subscriber: d});
        do {
            if (e++ >= a) {
                d.complete();
                break
