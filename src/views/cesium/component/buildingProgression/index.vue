...
const add3dtileset = () => {
  cctlLayer = new mars3d.layer.TilesetLayer({
    name: "buildingProgression",
    url: import.meta.env.VITE_APP_GISDATA + '/cctl/osm_community/tileset.json', //数据地址
...
const mapResetCamera = () => {
  // {"y": 43.938308, "x": 125.343775, "z": 42278.27, "heading": 0, "pitch": -90, "roll": 0}
  viewer.camera.flyTo({
