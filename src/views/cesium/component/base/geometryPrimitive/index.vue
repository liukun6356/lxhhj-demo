<template>
  <div class="geometryPrimitive-wrap">
    <Tdt_img_d/>
  </div>
</template>
...
const addGeometryPrimitive = () => {
  if(prePrimitive)viewer.scene.primitives.remove(prePrimitive)
  ...
  prePrimitive = viewer.scene.primitives.add(
...
const addNormalPrimitive = () => {
  ...
  prePrimitive =  viewer.scene.primitives.add(new Cesium.Primitive({
    geometryInstances: instance,
...
const initGui = () => {
  ...
  gui.add(formData, "addGeometryPrimitive").name("自定义几何")
  gui.add(formData, "addNormalPrimitive").name("法线几何")
}
